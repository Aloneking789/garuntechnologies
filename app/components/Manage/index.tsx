...
const names = [
    {
        ...
        user: 'per project',
        button: "Get Started",
        profiles: 'Landing Page Design',
        posts: 'Responsive Development',
        templates: "Basic SEO Setup",
        view: "React/Next.js",
    ...
    },
    {
        ...
        posts: 'React Native Development',
        templates: "API Integration",
        view: "Play Store Publishing",
    ...
    },
    {
        ...
        user: 'per project',
        button: "Get Started",
        profiles: 'Custom AI Integration',
        posts: 'Intelligent Automation',
        templates: "ML Model Development",
    ...
    return (
        <div id="services-section">
            <div className='mx-auto max-w-7xl sm:py-20 lg:px-8 my-16'>
                <h3 className='text-center text-4xl sm:text-65xl font-black'>Flexible Packages for <br /> Your Development Needs.</h3>
