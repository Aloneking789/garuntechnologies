            ...
            <div className='mx-auto max-w-7xl px-4 my-40 pb-20 lg:pb-40 lg:px-8 bg-digital rounded-3xl bg-blue relative'>
                <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                    ...
                    <div className="pt-24 lg:pl-24 ">
                        ...
                        <h4 className="text-4xl sm:text-6xl font-bold text-white mb-8 leading-snug text-center lg:text-start">We are a technology <br /> agency from Gorakhpur <br /> building AI-powered solutions.</h4>
                    ...
                    <div>
                        <div className="lg:absolute girldoodle">
                            <Image src="https://cdn.jsdelivr.net/gh/Aloneking789/garuntechnologies@main/public/images/digital/girldoodle.svg" alt="girldoodle" width={815} height={691} />
                        </div>
                    </div>
